...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'laviedesplantes_backup_6705ee77fe0ea5e04928_20240528174032_archive.zip';
        const ARCHIVE_SIZE       = '149233038';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '6705ee7-28174032';
        const SECONDARY_PACKAGE_HASH = '4bdd32c-28174032';
        const VERSION            = '1.5.9';
